...
class SalonController extends Controller
{
    ...
    {
        $salons = Salon::select('id', 'salon_name', 'image_name', 'information', 'location', 'x-location', 'y-location')->get();
    ...
    {
        $salons = Salon::select('id', 'salon_name', 'image_name', 'information', 'location',  'x-information', 'y-information')->get();
